...
// getPaymentsOverviewData: moved to client-side fetching from Report endpoints.
// The PaymentsOverview chart now fetches `/Report/revenue/daily` and
// `/Report/revenue/monthly` directly from the browser using the `api` instance.
